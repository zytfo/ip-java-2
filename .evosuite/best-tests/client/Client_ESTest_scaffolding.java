...
public class Client_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "client.Client"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("client.InputReader", false, Client_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("client.MessageReceiver", false, Client_ESTest_scaffolding.class.getClassLoader()));
  }
